...
public class ResetButton extends BaseButton {
    ...
    public ResetButton(StageConfig config) {
    ...
    private InputListener listener = new InputListener() {
        ...
        public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
            ...
            ((GameStage) getStage()).handleKeyPressedEvent(TouchEventListener.INPUT_EVENT.Reset);
    ...
    public void show() {
        ...
        StageConfig sc = JsonConfigFactory.getInstance().getStageConfig("timerace_game_reset");
